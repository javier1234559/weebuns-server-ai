...
export const users: Prisma.UserCreateInput[] = [
    {
        ...
        passwordHash: '$2b$10$11zWAeJIiwBV7rI.TYlF4.nW/kLj67MvHs5j8BFcMeG9XgHXx8pci',
        role: UserRole.user,
...
export const createLessons = (userIds: string[], referenceDataId: string[]) => [
    {
        ...
        timeLimit: 40,
        content: {
            prompt: 'Some people think that children should begin their formal education at a very early age and should spend most of their time on school studies. Others believe that young children should spend most of their time playing. Discuss both views and give your own opinion.',
            instructions: [
