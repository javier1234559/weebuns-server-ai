...
async function seedReferenceData() {
    ...
    console.log(`Created ${generatedIds.referenceData.length} reference data entries`);
}
...
async function seedTeacherProfiles() {
    ...
    console.log(`Created ${generatedIds.teacherProfiles.length} teacher profiles`);
}
...
async function seedStudentProfiles() {
    ...
    console.log(`Created ${generatedIds.studentProfiles.length} student profiles`);
}
