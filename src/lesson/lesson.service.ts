...
import { ILessonService } from 'src/lesson/interface/lesson-service.interface';
import { ILessonWhere } from 'src/lesson/interface/lesson-where.interface';
...
export class LessonService implements ILessonService {
  ...
  async update(
    ...
    if (lesson.createdById !== userId && user.role !== 'admin') {
